  ...
  return [
    {
      ...
      plan: [{ section: 'worklife', text: 'Protect two fixed study blocks a day', done: true }],
    ...
    },
    {
      ...
      plan: [
        { section: 'content', text: 'Book weekly sessions with a course tutor', done: true },
        { section: 'content', text: 'Go to the SI / hot-seat sessions each week', done: true },
        { section: 'assessments', text: 'Do a timed past paper before the next test', done: false },
        { section: 'worklife', text: 'Map training and study into one weekly plan', done: true },
        { section: 'careers', text: 'Meet an alumnus working in my target field', done: false },
      ],
